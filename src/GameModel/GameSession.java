...
public class GameSession {
	...
	//Creating pieces
	public static Piece piece1 = new Piece(1, 1, coord1, 0,0);
	public static Piece piece2 = new Piece(2, 2, coord2, 0,0);
	public static Piece piece3 = new Piece(3, 3, coord3, 0,0);
	public static Piece piece4 = new Piece(4, 4, coord4, 0,0);
	public static Piece piece5 = new Piece(5, 5, coord5, 0,0);
	public static Piece piece6 = new Piece(6, 6, coord6, 0,0);
	public static Piece piece7 = new Piece(7, 7, coord7, 0,0);
	public static Piece piece8 = new Piece(8, 8, coord8, 0,0);
	public static Piece piece9 = new Piece(9, 9, coord9, 0,0);
	public static Piece piece10 = new Piece(10, 1, coord10, 0,0);
	public static Piece piece11 = new Piece(11, 1, coord11, 0,0);
	public static Piece piece12 = new Piece(12, 1, coord12, 0,0);
	...
	public boolean pieceInRange(int headX, int headY){
        ...
        for(int count = 0; count < selectedPiece.getSizeofPiece();count++) {
