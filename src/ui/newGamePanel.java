...
public class newGamePanel extends GuiPanel {
	...
	public newGamePanel() {
		super();
		GuiButton d2button = new GuiButton(Game.WIDTH / 2 - buttonWitdh / 2,
				220, buttonWitdh, buttonHeight);
		GuiButton d3button = new GuiButton(Game.WIDTH / 2 - buttonWitdh / 2,
				310, buttonWitdh, buttonHeight);
		GuiButton storybutton = new GuiButton(Game.WIDTH / 2 - buttonWitdh / 2,
