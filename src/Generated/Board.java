...
public class Board extends JPanel {
	...
	static private PiecesBasket basket;

	public Board(int width, int height, int TileTypee) {
		
		Inventory inventory = new Inventory(1);
		PiecesBasket basket = new PiecesBasket();
	...
	static private void AddPiecesToBoard() {
...
//		b.addKeyListener(keyy);
		...
		for(int i= 0; i < basket.allPieces.size(); i++)
		{
			inventoryPanel.add(  basket.allPieces.get(i) );
		}
