...
public class gameOptionsPanel extends panelTemp {
	...
	public gameOptionsPanel() {
		...
		lblSelectGameOptons.setFont(new Font("Gadugi", Font.BOLD, 30));
		...
		final JRadioButton rdbtnClassic = new JRadioButton("Classic");
		...
		this.setComponentZOrder(lblNewLabel_1, 13);
